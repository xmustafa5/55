...
function HomePage() {
    return (
        <div className="flex flex-col justify-center items-center overflow-hidden w-full h-screen p-[175px] px-[181px] bg-[#001487] [background-image:linear-gradient(0deg,rgba(255,255,255,0.04)_0%,rgba(255,255,255,0.04)_100%)]">
            {noiseSvg}
